...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 17, 2025 at 06:50 PM
...
('11111', '2025-01-10', '10001'),
('12345', '2025-04-09', '10002'),
('1938', '2025-04-15', '10001'),
('38421', '2025-04-04', '10003');
...
('11111', '2025-01-10', 111),
('12345', '2025-04-01', 134),
('1938', '2025-04-02', 38),
('23', '2025-04-13', 13),
('333', '2025-03-03', 333),
('38421', '2025-04-01', 34),
('55555', '2025-01-09', 134),
('88888', '2025-04-01', 81);
...
INSERT INTO `commandedocument` (`id`, `nbExemplaire`, `idLivreDvd`, `idSuivi`, `Libelle`) VALUES
('23', 5, '20001', '00002', 'livrée'),
('333', 3, '00003', '00002', 'livrée');

--
-- Triggers `commandedocument`
--
DROP TRIGGER IF EXISTS `insert_exemplaires_livree`;
DELIMITER $$
CREATE TRIGGER `insert_exemplaires_livree` AFTER UPDATE ON `commandedocument` FOR EACH ROW BEGIN
    DECLARE i INT DEFAULT 1;
    DECLARE maxNum INT;

    IF NEW.Libelle = 'livrée' AND OLD.Libelle != 'livrée' THEN
        ...
        WHILE i <= NEW.nbExemplaire DO
            INSERT INTO exemplaire (numero, dateAchat, photo, idEtat, id)
            VALUES (
                maxNum + i,
...
('00003', 1, '2025-03-03', '', '00001'),
('00003', 2, '2025-03-03', '', '00001'),
('00003', 3, '2025-03-03', '', '00001'),
('00003', 4, '2025-04-01', '', '00001'),
('00003', 5, '2025-04-01', '', '00001'),
('00003', 6, '2025-04-01', '', '00001'),
('10001', 23, '2025-03-15', '', '00001'),
...
('20001', 1, '2025-04-13', '', '00001'),
('20001', 2, '2025-04-13', '', '00001'),
('20001', 3, '2025-04-13', '', '00001'),
('20001', 4, '2025-04-13', '', '00001'),
('20001', 5, '2025-04-13', '', '00001');
...
CREATE TABLE IF NOT EXISTS `service` (
  ...
  `libelle` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
('00001', 'Service Administratif'),
('00002', 'Service Prêts'),
('00003', 'Service Culture'),
...
INSERT INTO `utilisateur` (`login`, `password`, `nom`, `prenom`, `idService`) VALUES
('admin', 'P@$$word1', 'Mukuri Maka', 'Jonas', '00004'),
('culture1', 'password789', 'Lemoine', 'Paul', '00003'),
('pret1', 'password456', 'Martin', 'Claire', '00002'),
('serviceadmin', 'password123', 'Dupont', 'Jean', '00001');
...
ALTER TABLE `commandedocument`
  ADD CONSTRAINT `commandedocument_ibfk_1` FOREIGN KEY (`id`) REFERENCES `commande` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
